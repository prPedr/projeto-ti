...
export const criarOpcaoSchema = z.object({
  body: z.object({
    ...
    tipo_equipamento: z.enum(['COMPUTADOR', 'SWITCH', 'CELULAR', 'NVR_CAMERA', 'IMPRESSORA']).nullable().optional(),
  }),
})

export const listarOpcoesQuerySchema = z.object({
  categoria: z.string().optional(),
  tipo_equipamento: z.enum(['COMPUTADOR', 'SWITCH', 'CELULAR', 'NVR_CAMERA', 'IMPRESSORA']).optional(),
})
